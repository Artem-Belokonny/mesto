...
export const popupAvatarEditOpenButton = document.querySelector('.profile__avatar');
...
export const popupDeleteConfirmButton = document.querySelector('.popup__save_delete');