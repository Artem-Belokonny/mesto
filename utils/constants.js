...
export const popupName = document.querySelector('.popup__input_edit_name');
export const popupJob = document.querySelector('.popup__input_edit_job');
export const formEditElement = document.querySelector('.popup__container_edit');
...
export const addFormPlaceInput = document.querySelector('.popup__input_add-title');
export const addFormLinkInput = document.querySelector('.popup__input_add-link');
